...
var lt = /*#__PURE__*/function () {
  ...
  return _createClass(lt, null, [{
    ...
    value: function apply(e, t) {
      if (t) try {
        lt.applyStyleSheet(e, t);
      } catch (_unused) {
        lt.addStyleElement(e, t);
      }
    }
  }, {
    key: "applyStyleSheet",
    ...
    value: function applyDefaultStyleToComponent(e, t) {
      t && O.applyToStyleIfNotDefined(e, t), O.applyToStyleIfNotDefined(e, lt.DEFAULT_COMPONENT_STYLE);
    }
  }]);
}();
...
Je.PERMITTED_KEYS = /* @__PURE__ */new Set([F.BACKSPACE, F.DELETE, F.ARROW_RIGHT, F.ARROW_LEFT, F.ARROW_DOWN, F.ARROW_UP, F.META, F.CONTROL, F.ENTER]);
var Xi = Je;
...
var Xe = /*#__PURE__*/function () {
  function Xe(e, t, i) {
    ...
    this.elementRef = Xe.createContainerElement((r = s == null ? void 0 : s.styles) == null ? void 0 : r.container), this._config = s, this.inputElementRef = this.createInputElement(), this.elementRef.appendChild(this.inputElementRef), e.setPlaceholderText = this.setPlaceholderText.bind(this), e.setPlaceholderText(((o = this._config.placeholder) == null ? void 0 : o.text) || "Ask me anything!"), setTimeout(function () {
      Xi.add(_this.inputElementRef, i, _this._config.characterLimit, e._validationHandler);
    });
  }
...
function gs(n, e, t, i) {
  var s = "\n".concat(Is(e), " message: ").concat(JSON.stringify(n), " \n"),
    r = t ? "".concat(Is(e), " message after interceptor: ").concat(qn(i), " \n") : "";
  return s + r;
}
function Hn(n, e, t, i) {
  return "".concat(gs(n, e, t, i), "Make sure the ").concat(e, " message is using the Response format: https://deepchat.dev/docs/connect/#Response \nYou can also augment it using the responseInterceptor property: https://deepchat.dev/docs/interceptors#responseInterceptor");
}
function zn(n, e, t) {
  var i = "response";
  return "".concat(gs(n, i, e, t), "Make sure the ").concat(i, " message is using the {text: string} format, e.g: {text: \"Model Response\"}");
}
function Gn(n, e) {
  var t = "request";
  return "".concat(gs(n, t, e), "Make sure the ").concat(t, " message is using the {body: {text: string}} format, e.g: {body: {text: \"Model Response\"}}");
}
var Os = "Make sure the events are using {text: string} or {html: string} format.\nYou can also augment them using the responseInterceptor property: https://deepchat.dev/docs/interceptors#responseInterceptor",
  k = {
  ...
  return _createClass(ct, null, [{
    ...
    value: function setDots(e, t) {
      ...
      if ((o = (r = (s = (i = t == null ? void 0 : t.loading) == null ? void 0 : i.message) == null ? void 0 : s.styles) == null ? void 0 : r.bubble) != null && o.color) {
        var a = ct.colorToHex(t.loading.message.styles.bubble.color);
...
ct.BUBBLE_CLASS = "deep-chat-loading-message-bubble", ct.DOTS_CONTAINER_CLASS = "deep-chat-loading-message-dots-container";
var Pe = ct;
    ...
    value: function applyDeepChatUtilities(e, t, i) {
      Ps.forEach(function (r) {
        ...
        Array.from(o || []).forEach(function (a) {
          ...
          Y.applyStylesToElement(a, l), Se.applyEvents(a, r);
        });
      });
...
var Y = /*#__PURE__*/function () {
  ...
  return _createClass(Y, null, [{
    ...
    value: function applyClassUtilitiesToElement(e, t) {
      var i = t.events,
        s = t.styles;
      i && Y.applyEventsToElement(e, i), s && !Se.doesElementContainDeepChatClass(e) && Y.applyStylesToElement(e, s);
    }
  }, {
    ...
    value: function applyCustomClassUtilities(e, t) {
      Object.keys(e).forEach(function (i) {
        ...
        Array.from(s).forEach(function (r) {
          e[i] && Y.applyClassUtilitiesToElement(r, e[i]);
        });
      });
    }
  }, {
    key: "apply",
    value: function apply(e, t) {
      Se.applyDeepChatUtilities(e, e.htmlClassUtilities, t), Y.applyCustomClassUtilities(e.htmlClassUtilities, t);
    }
  }, {
    key: "traverseNodes",
...
var Me = /*#__PURE__*/function () {
  ...
  return _createClass(Me, null, [{
    ...
    value: function createElements(e, t, i, s) {
      ...
      return o.bubbleElement.classList.add(Me.HTML_BUBBLE_CLASS), o.bubbleElement.innerHTML = t, o;
    }
  }, {
    key: "overwriteElements",
    value: function overwriteElements(e, t, i) {
      i.bubbleElement.innerHTML = t, Y.apply(e, i.outerContainer), te.flagHTMLUpdateClass(i.bubbleElement);
    }
    // prettier-ignore
  }, {
    key: "overwrite",
    value: function overwrite(e, t, i, s) {
      var r = e.messageToElements,
        o = y.overwriteMessage(r, s, t, i, "html", Me.HTML_BUBBLE_CLASS);
    ...
    value: function create(e, t, i) {
      ...
      return y.fillEmptyMessageElement(r.bubbleElement, t), Y.apply(e, r.outerContainer), te.flagHTMLUpdateClass(r.bubbleElement), e.applyCustomStyles(r, i, !1, (o = e.messageStyles) == null ? void 0 : o.html), r;
    }
  }, {
    key: "add",
    value: function add(e, t, i, s) {
      ...
      if (r && e.messageElementRefs.length > 0 && Y.isTemporaryBasedOnHTML(t)) return;
      var o = Me.create(e, t, i, r);
      return r || Me.addElement(e, o.outerContainer), o;
    }
  }]);
}();
...
function Zn(n, e) {
  var t = 0,
    i = yn(e);
  return e !== i ? i : e.charCodeAt(0) === 35 && Yn.test(e) && (t = e[1].toLowerCase() === "x" ? parseInt(e.slice(2), 16) : parseInt(e.slice(1), 10), Sn(t)) ? Zi(t) : n;
}
function tt(n) {
...
b.blockquote_close = function (n, e) {
  return "</blockquote>" + st(n, e);
};
b.code = function (n, e) {
  return n[e].block ? "<pre><code>" + ee(n[e].content) + "</code></pre>" + st(n, e) : "<code>" + ee(n[e].content) + "</code>";
};
b.fence = function (n, e, t, i, s) {
  var r = n[e],
    o = "",
    a = t.langPrefix,
    l = "",
...
b.fence_custom = {};
b.heading_open = function (n, e) {
  return "<h" + n[e].hLevel + ">";
};
b.heading_close = function (n, e) {
  return "</h" + n[e].hLevel + ">\n";
};
b.hr = function (n, e, t) {
  return (t.xhtmlOut ? "<hr />" : "<hr>") + st(n, e);
};
b.bullet_list_open = function () {
  return "<ul>\n";
};
b.bullet_list_close = function (n, e) {
  return "</ul>" + st(n, e);
};
b.list_item_open = function () {
  return "<li>";
};
b.list_item_close = function () {
  return "</li>\n";
};
b.ordered_list_open = function (n, e) {
  var t = n[e],
    i = t.order > 1 ? ' start="' + t.order + '"' : "";
  return "<ol" + i + ">\n";
};
b.ordered_list_close = function (n, e) {
  return "</ol>" + st(n, e);
};
b.paragraph_open = function (n, e) {
  return n[e].tight ? "" : "<p>";
};
b.paragraph_close = function (n, e) {
  var t = !(n[e].tight && e && n[e - 1].type === "inline" && !n[e - 1].content);
  return (n[e].tight ? "" : "</p>") + (t ? st(n, e) : "");
};
b.link_open = function (n, e, t) {
  var i = n[e].title ? ' title="' + ee(tt(n[e].title)) + '"' : "",
    s = t.linkTarget ? ' target="' + t.linkTarget + '"' : "";
  return '<a href="' + ee(n[e].href) + '"' + i + s + ">";
};
b.link_close = function () {
  return "</a>";
};
...
b.table_open = function () {
  return "<table>\n";
};
b.table_close = function () {
  return "</table>\n";
};
b.thead_open = function () {
  return "<thead>\n";
};
b.thead_close = function () {
  return "</thead>\n";
};
b.tbody_open = function () {
  return "<tbody>\n";
};
b.tbody_close = function () {
  return "</tbody>\n";
};
b.tr_open = function () {
  return "<tr>";
...
b.strong_open = function () {
  return "<strong>";
};
b.strong_close = function () {
  return "</strong>";
};
b.em_open = function () {
  return "<em>";
...
b.del_close = function () {
  return "</del>";
};
b.ins_open = function () {
  return "<ins>";
};
b.ins_close = function () {
  return "</ins>";
};
b.mark_open = function () {
  return "<mark>";
};
b.mark_close = function () {
  return "</mark>";
};
b.sub = function (n, e) {
...
b.hardbreak = function (n, e, t) {
  return t.xhtmlOut ? "<br />\n" : "<br>\n";
};
b.softbreak = function (n, e, t) {
  return t.breaks ? t.xhtmlOut ? "<br />\n" : "<br>\n" : "\n";
};
b.text = function (n, e) {
  return ee(n[e].content);
};
b.htmlblock = function (n, e) {
  return n[e].content;
};
b.htmltag = function (n, e) {
  return n[e].content;
};
b.abbr_open = function (n, e) {
  return '<abbr title="' + ee(tt(n[e].title)) + '">';
};
b.abbr_close = function () {
  return "</abbr>";
};
b.footnote_ref = function (n, e) {
  var t = Number(n[e].id + 1).toString(),
    i = "fnref" + t;
  return n[e].subId > 0 && (i += ":" + n[e].subId), '<sup class="footnote-ref"><a href="#fn' + t + '" id="' + i + '">[' + t + "]</a></sup>";
};
b.footnote_block_open = function (n, e, t) {
  var i = t.xhtmlOut ? "<hr class=\"footnotes-sep\" />\n" : "<hr class=\"footnotes-sep\">\n";
  return i + "<section class=\"footnotes\">\n<ol class=\"footnotes-list\">\n";
};
b.footnote_block_close = function () {
  return "</ol>\n</section>\n";
};
b.footnote_open = function (n, e) {
  var t = Number(n[e].id + 1).toString();
  return '<li id="fn' + t + '"  class="footnote-item">';
};
b.footnote_close = function () {
  return "</li>\n";
};
b.footnote_anchor = function (n, e) {
  var t = Number(n[e].id + 1).toString(),
    i = "fnref" + t;
...
var st = b.getBreak = function (e, t) {
  return t = _n(e, t), t < e.length && e[t].type === "list_item_close" ? "" : "\n";
};
function bs() {
  this.rules = En({}, b), this.getBreak = b.getBreak;
}
...
function or(n, e, t, i) {
  ...
  for (o < a && c !== o && wn(s, o) ? (u = s.linkContent, o = s.pos) : (u = "", o = c); o < a && s.src.charCodeAt(o) === 32;) o++;
  return o < a && s.src.charCodeAt(o) !== 10 ? -1 : (h = An(n.slice(1, r)), _typeof(i.references[h]) > "u" && (i.references[h] = {
    title: u,
    href: d
  }), o);
}
...
function dr(n) {
  ...
  if (n.env.abbreviations) {
    for (n.env.abbrRegExp || (h = "(^|[" + Ns.split("").map(Ki).join("") + "])(" + Object.keys(n.env.abbreviations).map(function (m) {
      return m.substr(1);
    }).sort(function (m, p) {
      return p.length - m.length;
    }).map(Ki).join("|") + ")($|[" + Ns.split("").map(Ki).join("") + "])", n.env.abbrRegExp = new RegExp(h, "g")), d = n.env.abbrRegExp, t = 0, i = f.length; t < i; t++) if (f[t].type === "inline") {
...
function vr(n) {
  ...
  if (n.options.typographer) {
    for (v = [], p = n.tokens.length - 1; p >= 0; p--) if (n.tokens[p].type === "inline") {
      for (g = n.tokens[p].children, v.length = 0, e = 0; e < g.length; e++) if (t = g[e], !(t.type !== "text" || gr.test(t.text))) {
        for (a = g[e].level, f = v.length - 1; f >= 0 && !(v[f].level <= a); f--);
        v.length = f + 1, i = t.content, r = 0, o = i.length;
        e: for (; r < o && (Ds.lastIndex = r, s = Ds.exec(i), !!s);) {
          if (l = !Fs(i, s.index - 1), r = s.index + 1, m = s[0] === "'", c = !Fs(i, r), !c && !l) {
            m && (t.content = at(t.content, s.index, Bs));
            continue;
          }
          if (u = !c, h = !l, h) {
            for (f = v.length - 1; f >= 0 && (d = v[f], !(v[f].level < a)); f--) if (d.single === m && v[f].level === a) {
              d = v[f], m ? (g[d.token].content = at(g[d.token].content, d.pos, n.options.quotes[2]), t.content = at(t.content, s.index, n.options.quotes[3])) : (g[d.token].content = at(g[d.token].content, d.pos, n.options.quotes[0]), t.content = at(t.content, s.index, n.options.quotes[1])), v.length = f;
              continue e;
            }
          }
          u ? v.push({
            ...
            single: m,
            level: a
          }) : h && m && (t.content = at(t.content, s.index, Bs));
        }
      }
    }
  }
}
var $i = [["block", sr], ["abbr", rr], ["references", ar], ["inline", lr], ["footnote_tail", cr], ["abbr2", dr], ["replacements", mr], ["smartquotes", vr]];
function Cn() {
  this.options = {}, this.ruler = new oe();
  for (var n = 0; n < $i.length; n++) this.ruler.push($i[n][0], $i[n][1]);
}
...
function wr(n, e, t, i) {
  var s,
    ...
    Ls,
    Vi;
  if ((u = js(n, e)) >= 0) g = !0;else if ((u = Us(n, e)) >= 0) g = !1;else return !1;
  ...
  for (M = n.tokens.length, g ? (d = n.bMarks[e] + n.tShift[e], m = Number(n.src.substr(d, u - d - 1)), n.tokens.push({
    ...
    lines: ae = [e, 0],
    level: n.level++
  }), a = n.blkIndent, l = n.tight, o = n.tShift[e], c = n.parentType, n.tShift[e] = v - n.bMarks[e], n.blkIndent = r, n.tight = !0, n.parentType = "list", n.parser.tokenize(n, e, t, !0), (!n.tight || j) && (Ce = !1), j = n.line - e > 1 && n.isEmpty(n.line - 1), n.blkIndent = a, n.tShift[e] = o, n.tight = l, n.parentType = c, n.tokens.push({
    type: "list_item_close",
    level: --n.level
  }), s = e = n.line, ae[1] = s, v = n.bMarks[e], !(s >= t || n.isEmpty(s) || n.tShift[s] < n.blkIndent));) {
    for (Vi = !1, ie = 0, Ls = Ee.length; ie < Ls; ie++) if (Ee[ie](n, s, t, !0)) {
      Vi = !0;
      break;
    }
    if (Vi) break;
    if (g) {
      if (u = js(n, s), u < 0) break;
    } else if (u = Us(n, s), u < 0) break;
...
function Lr(n, e, t, i) {
  ...
  if (s = n.src.charCodeAt(a + 1), s === 33 || s === 63) {
    ...
    if (Tn[r[1].toLowerCase()] !== !0) return !1;
    if (i) return !0;
  } else return !1;
...
function Ir(n, e, t, i) {
  ...
  if (e + 2 > t || (l = e + 1, n.tShift[l] < n.blkIndent) || (o = n.bMarks[l] + n.tShift[l], o >= n.eMarks[l]) || (s = n.src.charCodeAt(o), s !== 124 && s !== 45 && s !== 58) || (r = Wi(n, e + 1), !/^[-:| ]+$/.test(r)) || (c = r.split("|"), c <= 2)) return !1;
  ...
  if (r = Wi(n, e).trim(), r.indexOf("|") === -1 || (c = r.replace(/^\||\|$/g, "").split("|"), u.length !== c.length)) return !1;
  if (i) return !0;
  for (n.tokens.push({
    type: "table_open",
    lines: f = [e, 0],
  ...
  for (n.tokens.push({
    ...
    lines: m = [e + 2, 0],
    level: n.level++
  }), l = e + 2; l < t && !(n.tShift[l] < n.blkIndent || (r = Wi(n, l).trim(), r.indexOf("|") === -1)); l++) {
  ...
  e: for (;;) {
    for (v = !0, g = !1, n.tokens.push({
      ...
      if (n.tokens.push({
        ...
        lines: a = [d, 0],
        level: n.level++
      }), p = n.tight, h = n.ddIndent, u = n.blkIndent, m = n.tShift[r], f = n.parentType, n.blkIndent = n.ddIndent = n.tShift[r] + 2, n.tShift[r] = s - n.bMarks[r], n.tight = !0, n.parentType = "deflist", n.parser.tokenize(n, r, t, !0), (!n.tight || g) && (v = !1), g = n.line - r > 1 && n.isEmpty(n.line - 1), n.tShift[r] = m, n.tight = p, n.parentType = f, n.blkIndent = u, n.ddIndent = h, n.tokens.push({
        type: "dd_close",
        level: --n.level
...
var Dr = /[\n\t]/g,
  Br = /\r[\n\u0085]|[\u2424\u2028\u0085]/g,
  Fr = /\u00a0/g;
vs.prototype.parse = function (n, e, t, i) {
  var s,
    r = 0,
    o = 0;
  if (!n) return [];
...
var ys = [];
for (var qs = 0; qs < 256; qs++) ys.push(0);
...
function Hr(n, e) {
  ...
  if (i++, i < s) {
    if (t = n.src.charCodeAt(i), t < 256 && ys[t] !== 0) return e || (n.pending += n.src[i]), n.pos += 2, !0;
    if (t === 10) {
      for (e || n.push({
        type: "hardbreak",
        level: n.level
...
function zs(n, e) {
  ...
  return t >= l && (o = !1), r = t - e, r >= 4 ? o = a = !1 : (s = t < l ? n.src.charCodeAt(t) : -1, (s === 32 || s === 10) && (o = !1), (i === 32 || i === 10) && (a = !1), c === 95 && (Hs(i) && (o = !1), Hs(s) && (a = !1))), {
    can_open: o,
    can_close: a,
    delims: r
  };
...
function $r(n, e) {
  ...
  if (l = zs(n, d), t = l.delims, !l.can_open) return n.pos += t, e || (n.pending += n.src.slice(d, n.pos)), !0;
  if (n.level >= n.options.maxNesting) return !1;
  for (n.pos = d + t, a = [t]; n.pos < c;) {
    if (n.src.charCodeAt(n.pos) === u) {
      if (l = zs(n, n.pos), i = l.delims, l.can_close) {
        for (r = a.pop(), o = i; r !== o;) {
          if (o < r) {
            a.push(r - o);
            break;
...
function Zr(n, e) {
  ...
  if (a = i + 1, a < h && n.src.charCodeAt(a) === 40) {
    ...
    if (a >= h) return !1;
    for (f = a, xn(n, a) ? (r = n.linkContent, a = n.pos) : r = "", f = a; a < h && (c = n.src.charCodeAt(a), !(c !== 32 && c !== 10)); a++);
    if (a < h && f !== a && wn(n, a)) for (o = n.linkContent, a = n.pos; a < h && (c = n.src.charCodeAt(a), !(c !== 32 && c !== 10)); a++);else o = "";
...
function no(n, e) {
  var t,
    ...
    o,
    a = n.pos;
  return n.src.charCodeAt(a) !== 60 || (t = n.src.slice(a), t.indexOf(">") < 0) ? !1 : (i = t.match(so), i ? to.indexOf(i[1].toLowerCase()) < 0 || (r = i[0].slice(1, -1), o = Qi(r), !n.parser.validateLink(r)) ? !1 : (e || (n.push({
    type: "link_open",
    href: o,
    level: n.level
  }), n.push({
    ...
    type: "link_close",
    level: n.level
  })), n.pos += i[0].length, !0) : (s = t.match(io), s ? (r = s[0].slice(1, -1), o = Qi("mailto:" + r), n.parser.validateLink(o) ? (e || (n.push({
    type: "link_open",
    href: o,
    level: n.level
  }), n.push({
...
function xo(n, e) {
  ...
  if (r + 1 < o) {
    if (t = n.src.charCodeAt(r + 1), t === 35) {
      if (s = n.src.slice(r).match(So), s) return e || (i = s[1][0].toLowerCase() === "x" ? parseInt(s[1].slice(1), 16) : parseInt(s[1], 10), n.pending += Sn(i) ? Zi(i) : Zi(65533)), n.pos += s[0].length, !0;
...
var Ji = [["text", jr], ["newline", qr], ["escape", Hr], ["backticks", zr], ["del", Gr], ["ins", Vr], ["mark", Kr], ["emphasis", $r], ["sub", Jr], ["sup", Yr], ["links", Zr], ["footnote_inline", Qr], ["footnote_ref", eo], ["autolink", no], ["htmltag", Eo], ["entity", xo]];
function ji() {
  this.ruler = new oe();
...
function xe(n, e) {
  typeof n != "string" && (e = n, n = "default"), e && e.linkify != null && console.warn("linkify option is removed. Use linkify plugin instead:\n\nimport Remarkable from 'remarkable';\nimport linkify from 'remarkable/linkify';\nnew Remarkable().use(linkify)\n"), this.inline = new ji(), this.block = new vs(), this.core = new Cn(), this.renderer = new bs(), this.ruler = new oe(), this.options = {}, this.configure(Ro[n]), this.set(e || {});
}
...
var dt = /*#__PURE__*/function () {
  ...
  return _createClass(dt, null, [{
    ...
    value: function instantiate(e) {
      if (e) return new xe(_objectSpread(_objectSpread({}, dt.DEFAULT_PROPERTIES), e));
      if (window.hljs) {
        var t = window.hljs;
        return new xe({
      ...
      } else return new xe(dt.DEFAULT_PROPERTIES);
    }
  }, {
    key: "createNew",
    value: function createNew(e) {
      var t = dt.instantiate(e);
...
var yi = /*#__PURE__*/function () {
  ...
  return _createClass(yi, null, [{
    ...
    value: function onMessage(e, t, i) {
      ...
      z.reAddFileRefToObject(t, s), (r = e.onMessage) == null || r.call(e, s), e.dispatchEvent(new CustomEvent("message", {
        detail: s
  ...
  return _createClass(B, null, [{
    ...
    value: function addMessage(e) {
      ...
      var i = (l = (a = (o = (r = e.messageStyles) == null ? void 0 : r.loading) == null ? void 0 : o.history) == null ? void 0 : a.full) == null ? void 0 : l.html,
        s = i ? _e.createElements(e, i, y.AI_ROLE, !0, !0) : B.createDefaultElements(e);
      return B.addLoadHistoryMessage(s, e, t), y.softRemRoleElements(s.innerContainer, e.avatar, e.name), s;
    }
  }, {
    ...
    value: function changeFullViewToSmall(e) {
      ...
      B.tryChangeViewToSmall(e, t) || B.tryChangeViewToSmall(e, e.messageElementRefs[0]);
    }
  }]);
}();
...
var Te = /*#__PURE__*/function (_Mn) {
  function Te(e) {
    var _this3;
    _classCallCheck(this, Te);
    _this3 = _callSuper(this, Te, ["avatar-container"]), _this3._avatars = e;
    return _this3;
  }
  _inherits(Te, _Mn);
  return _createClass(Te, [{
    ...
    value: function createAvatar(e, t) {
      ...
      e === y.USER_ROLE ? (i.src = ((r = t == null ? void 0 : t.user) == null ? void 0 : r.src) || ((o = t == null ? void 0 : t["default"]) == null ? void 0 : o.src) || es, i.onerror = Te.errorFallback.bind(this, es)) : (i.src = ((a = t == null ? void 0 : t[e]) == null ? void 0 : a.src) || ((l = t == null ? void 0 : t.ai) == null ? void 0 : l.src) || ((c = t == null ? void 0 : t["default"]) == null ? void 0 : c.src) || Gs, i.onerror = Te.errorFallback.bind(this, Gs)), i.classList.add("avatar"), i.alt = "".concat(e, " avatar");
      var s = document.createElement("div");
      return s.classList.add(this.className), s.appendChild(i), t && Te.applyCustomStyles(s, i, t, e), s;
    }
  }, {
    key: "getPosition",
    ...
    value: function applyCustomStyles(e, t, i, s) {
      var r, o, a, l;
      if ((r = i["default"]) != null && r.styles && Te.applyCustomStylesToElements(e, t, i["default"].styles), s === y.USER_ROLE) (o = i.user) != null && o.styles && Te.applyCustomStylesToElements(e, t, i.user.styles);else {
...
var Ht = /*#__PURE__*/function (_Mn2) {
  function Ht(e) {
    var _this4;
    _classCallCheck(this, Ht);
    _this4 = _callSuper(this, Ht, ["name"]), _this4._names = e;
    return _this4;
  }
  _inherits(Ht, _Mn2);
  return _createClass(Ht, [{
    ...
    value: function createName(e, t) {
      var i = document.createElement("div");
      return i.classList.add(this.className), i.textContent = Ht.getNameText(e, t), Ht.applyStyle(i, e, t), i;
    }
  }], [{
    key: "getPosition",
    value: function getPosition(e, t) {
...
var Q = /*#__PURE__*/function () {
  ...
  return _createClass(Q, [{
    ...
    value: function addNewTextMessage(e, t, i) {
      ...
      return r.bubbleElement.classList.add(Q.TEXT_BUBBLE_CLASS), this.applyCustomStyles(r, t, !1), y.fillEmptyMessageElement(r.bubbleElement, e), r;
    }
    // prettier-ignore
  }, {
    key: "overwriteText",
    value: function overwriteText(e, t, i) {
      var s = y.overwriteMessage(this.messageToElements, i, t, e, "text", Q.TEXT_BUBBLE_CLASS);
    ...
    value: function appendNewMessageElementFocusMode(e, t) {
      ...
      if (this.appendOuterContainerElemet(i.outerContainer, t), t === "user") {
        var o = typeof this.focusMode != "boolean" && ((s = this.focusMode) == null ? void 0 : s.isScroll);
        setTimeout(function () {
          return Z.scrollToBottom(_this6.elementRef, o);
        });
      } else (r = this.messageElementRefs[this.messageElementRefs.length - 2]) == null || r.outerContainer.scrollIntoView();
      return i;
    }
  }, {
    ...
    value: function createNewGroupElementFocusMode() {
      var t;
      (t = this._lastGroupMessagesElement) == null || t.classList.remove(Q.LAST_GROUP_MESSAGES_ACTIVE);
      var e = document.createElement("div");
      this._lastGroupMessagesElement && e.classList.add(Q.LAST_GROUP_MESSAGES_ACTIVE), this._lastGroupMessagesElement = e;
    }
  }, {
    ...
    value: function createAndAppendNewMessageElementDefault(e, t) {
      ...
      return this.appendOuterContainerElemet(i.outerContainer), setTimeout(function () {
        return Z.scrollToBottom(_this7.elementRef);
      }), i;
    }
  }, {
    ...
    value: function createAndPrependNewMessageElement(e, t, i) {
      ...
      if (i && (o = this.elementRef.firstChild) != null && o.classList.contains(Q.INTRO_CLASS)) {
    ...
    value: function isTemporaryElement(e) {
      return Q.isLoadingMessage(e) || Se.isElementTemporary(e);
    }
  }, {
...
var _ = /*#__PURE__*/function () {
  ...
  return _createClass(_, null, [{
    ...
    value: function generateMessageBodyElements(e, t) {
      var i = {};
      return e.text && (i.text = _.findMessageElements(t, he.TEXT_BUBBLE_CLASS)), e.html && (i.html = _.findMessageElements(t, _e.HTML_BUBBLE_CLASS)), e.files && (i.files = _.filterdMessageElements(t, z.FILE_BUBBLE_CLASS)), i;
    }
  }, {
...
var ht = /*#__PURE__*/function () {
  ...
  return _createClass(ht, [{
    ...
    value: function setInitialState(e, t, i) {
      this._streamType = e, i !== null && i !== void 0 ? i : i = y.AI_ROLE, this._elements = e === "text" ? this._messages.addNewTextMessage(t, i) : _e.add(this._messages, t, i), this._elements && (this._elements.bubbleElement.classList.add(ht.MESSAGE_CLASS), this._activeMessageRole = i, this._message = _defineProperty({
    ...
    value: function finaliseStreamedMessage() {
      ...
      if (!(this._endStreamAfterOperation || !this._message) && !(this._fileAdded && !this._elements)) {
        ...
        (e = this._elements.bubbleElement) != null && e.classList.contains(ht.MESSAGE_CLASS) && (this._streamType === "text" ? this._messages.textToSpeech && mt.speak(this._message.text || "", this._messages.textToSpeech) : this._streamType === "html" && this._elements && Y.apply(this._messages, this._elements.outerContainer), this._elements.bubbleElement.classList.remove(ht.MESSAGE_CLASS), this._message && this._messages.sendClientUpdate(he.createMessageContent(this._message), !1), this._hasStreamEnded = !0);
      }
    }
  }, {
    key: "markFileAdded",
...
function Lo(n, e, t) {
  ...
  return function (o, a) {
    if (o.length === 0) t == null || t(i), i = Vs();else if (a > 0) {
...
function Do(n) {
  ...
  if (!(e != null && e.startsWith(ts))) throw new Error("Expected content-type to be ".concat(ts, ", Actual: ").concat(e));
}
          ...
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 15:
              d = new we(i), u = E.fetch.bind(this, e, l, s), h = {
                ...
                headers: l,
                credentials: (v = e.connectSettings) == null ? void 0 : v.credentials,
          ...
          return _regeneratorRuntime().wrap(function _callee8$(_context8) {
            while (1) switch (_context8.prev = _context8.next) {
              ...
              case 15:
                ...
                _context8.next = 18;
                return (M = (v = e.deepChat).responseInterceptor) == null ? void 0 : M.call(v, ae);
              case 18:
            ...
            while (1) switch (_context14.prev = _context14.next) {
              ...
              case 8:
                if (A.isSimulation(e.stream)) {
                  l = H.stream.bind(_this9, e, i, s), c = s[o.role || y.AI_ROLE];
        ...
        return _regeneratorRuntime().wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            case 0:
              ...
              return _context15.abrupt("return", ye.request(e, i));
            case 3:
              r = e.websocket;
              if (!(!r || r === "pending")) {
                _context15.next = 6;
                ...
                case 4:
                  ...
                  if (!u) console.error(k.INVALID_RESPONSE(d, "server", !!e.deepChat.responseInterceptor, u)), t.addNewErrorMessage("service", "Error in server message");else {
                    ...
                    if (f) console.error(f.error), t.isLastMessageError() || t.addNewErrorMessage("service", f.error);else if (A.isSimulation(e.stream)) {
                      m = u, p = H.stream.bind(_this10, e, t, i.roleToStream), g = i.roleToStream[m.role || y.AI_ROLE];
        ...
        return _regeneratorRuntime().wrap(function _callee21$(_context21) {
          while (1) switch (_context21.prev = _context21.next) {
            ...
            case 11:
              ...
              return _context21.abrupt("return", ve.request(e, o, i));
            case 13:
              if (!(((m = e.connectSettings) == null ? void 0 : m.url) === ye.URL)) {
                _context21.next = 15;
                break;
              }
              return _context21.abrupt("return", ye.request(e, i));
            case 15:
              d = !0;
                ...
                var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee20(p) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee20$(_context20) {
                    while (1) switch (_context20.prev = _context20.next) {
                      ...
                      case 2:
                        _context20.next = 4;
                        return (j = (M = e.deepChat).responseInterceptor) == null ? void 0 : j.call(M, p);
                      case 4:
                      ...
                      case 15:
                        v.makingAnotherRequest || (A.isSimulatable(e.stream, v) ? A.simulate(i, e.streamHandlers, v) : ((Array.isArray(v) ? v : [v]).forEach(function (ae) {
          ...
          while (1) switch (_context27.prev = _context27.next) {
            ...
            case 5:
              ...
              this.populateMessages(t, i), s === 0 && setTimeout(function () {
                return Z.scrollToBottom(_this15._messages.elementRef);
              }, 0);
              _context27.next = 13;
              break;
            case 10:
  ...
  return _createClass(D, null, [{
    ...
    value: function processMixedFiles(e, t, i) {
      if (i) {
        ...
        e.fileTypes.mixedFiles = D.parseConfig(e.connectSettings, s, t, i);
      }
    }
    ...
    value: function processMicrophone(e, t, i, s) {
      ...
      i && (navigator.mediaDevices.getUserMedia !== void 0 ? (e.recordAudio = D.parseConfig(e.connectSettings, o, t, i), _typeof(i) == "object" && i.files && ((_l$files = (l = e.recordAudio).files) !== null && _l$files !== void 0 ? _l$files : l.files = {}, e.recordAudio.files.format = (c = i.files) == null ? void 0 : c.format, e.recordAudio.files.maxDurationSeconds = (d = i.files) == null ? void 0 : d.maxDurationSeconds, (u = e.fileTypes.audio) != null && u.files && ((_h$maxNumberOfFiles = (h = e.fileTypes.audio.files).maxNumberOfFiles) !== null && _h$maxNumberOfFiles !== void 0 ? _h$maxNumberOfFiles : h.maxNumberOfFiles = i.files.maxNumberOfFiles))) : s || (e.fileTypes.audio = D.parseConfig(e.connectSettings, o, t, i)));
    }
    // prettier-ignore
  }, {
    ...
    value: function processAudioConfig(e, t, i, s) {
      ...
      e.fileTypes.audio = D.parseConfig(e.connectSettings, o, t, i);
    }
    // prettier-ignore
  }, {
    ...
    value: function processGifConfig(e, t, i, s) {
      ...
      e.fileTypes.gifs = D.parseConfig(e.connectSettings, o, t, i);
    }
    ...
    value: function processCamera(e, t, i, s) {
      ...
      i && (navigator.mediaDevices.getUserMedia !== void 0 ? (e.camera = D.parseConfig(e.connectSettings, o, t, i), _typeof(i) == "object" && (e.camera.modalContainerStyle = i.modalContainerStyle, i.files && ((_l$files2 = (l = e.camera).files) !== null && _l$files2 !== void 0 ? _l$files2 : l.files = {}, e.camera.files.format = (c = i.files) == null ? void 0 : c.format, e.camera.files.dimensions = (d = i.files) == null ? void 0 : d.dimensions))) : s || (e.fileTypes.images = D.parseConfig(e.connectSettings, o, t, i)));
    }
    // prettier-ignore
  }, {
    ...
    value: function processImagesConfig(e, t, i, s) {
      ...
      e.fileTypes.images = D.parseConfig(e.connectSettings, o, t, i);
    }
        ...
        return _regeneratorRuntime().wrap(function _callee33$(_context33) {
          while (1) switch (_context33.prev = _context33.next) {
            case 0:
              ...
              throw new Error("Request settings have not been set up");
            case 2:
              i = bt.processMessages(t.messageToElements.map(function (_ref13) {
...
var ke = /*#__PURE__*/function (_HTMLElement) {
  ...
  function ke() {
    ...
    _this17 = _callSuper(this, ke), _this17._waitingToRender_ = !1, _this17._propUpdated_ = !1, Object.keys(ke._attributeToProperty_).forEach(function (e) {
  ...
  return _createClass($, null, [{
    ...
    value: function addVerificationEvents(e, t, i, s, r) {
      ...
      t.onclick = a, e.onkeydown = function (l) {
        !e.classList.contains("loading") && l.key === F.ENTER && a();
      };
    }
  }, {
...
var $s = {
  ...
  C = /*#__PURE__*/function (_it2) {
    function C(e) {
      var _this18;
      _classCallCheck(this, C);
      var t, i;
      _this18 = _callSuper(this, C, [e]), _this18._isModelLoaded = !1, _this18._isModelLoading = !1, _this18._loadOnFirstMessage = !1, _this18._webModel = {}, _this18.permittedErrorPrefixes = [C.MULTIPLE_MODELS_ERROR, C.WEB_LLM_NOT_FOUND_ERROR, C.GENERIC_ERROR], _this18._conversationHistory = [], _typeof(e.webModel) == "object" && (_this18._webModel = e.webModel), (t = _this18._webModel.load) != null && t.clearCache && C.clearAllCache(), _this18.findModelInWindow(e), _this18.canSendMessage = _this18.canSubmit.bind(_assertThisInitialized(_this18)), _this18._chatEl = (i = e.shadowRoot) == null ? void 0 : i.children[0], e.history && C.setUpHistory(_this18._conversationHistory, e.history);
      return _this18;
    }
    ...
    return _createClass(C, [{
      ...
      value: function scrollToTop(e) {
        ...
        ((t = this._webModel.introMessage) == null ? void 0 : t.autoScroll) !== !1 && setTimeout(function () {
          var i, s;
          (i = _this21._messages) != null && i.elementRef && Z.scrollToTop((s = _this21._messages) == null ? void 0 : s.elementRef);
        }, e);
      }
      // prettier-ignore
    }, {
      ...
      value: function attemptToCreateChat() {
        ...
        return $s.use_web_worker && e ? new window.webLLM.ChatWorkerClient(e) : new window.webLLM.ChatModule();
      }
    }, {
      key: "getConfig",
              ...
              case 0:
                ...
                s = function s(f) {
                  ...
                  (m = _this22._messages) == null || m.addNewMessage({
                    ...
                    var p;
                    return Z.scrollToBottom((p = _this22._messages) == null ? void 0 : p.elementRef);
                  }), i = !1);
                };
                  ...
                  var _ref15 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee40(r, o) {
                    ...
                    return _regeneratorRuntime().wrap(function _callee40$(_context40) {
                      while (1) switch (_context40.prev = _context40.next) {
                        case 0:
                          _context40.next = 2;
                          return C.processResponse(_this23.deepChat, e, {
                            text: o
                          });
                        case 2:
                          a = _context40.sent;
  ...
  return _createClass(He, [{
        ...
        return _regeneratorRuntime().wrap(function _callee80$(_context80) {
          while (1) switch (_context80.prev = _context80.next) {
            ...
            case 9:
              i = _context80.sent;
            case 10:
              return _context80.abrupt("return", Re.processAPIMessages(this, i, t, this.urlSegments));
            case 11:
            case "end":
    ...
    value: function processImageMessage(e, t) {
      var i = t == null ? void 0 : t.filter(function (s) {
        return z.isImageFileExtension(s.name);
      }).map(function (s) {
        return {
          type: "image_file",
          image_file: {
...
var ut = /*#__PURE__*/function (_Ri2) {
  function ut(e) {
    ...
    var t = JSON.parse(JSON.stringify(e.directConnection)),
      ...
      l = {
        threadsPrefix: "".concat(o).concat(ut.THREAD_RESOURCE),
        threadsPosfix: a,
        newAssistantUrl: "".concat(o).concat(ut.NEW_ASSISTANT_RESOURCE).concat(a),
...
var G = /*#__PURE__*/function () {
  ...
  return _createClass(G, null, [{
    ...
    value: function createElement(e, t) {
      return t ? G.createTextElement(e) : V.createSVGElement(e);
    }
  }, {
    ...
    value: function createCustomElement(e, t) {
      ...
      if ((s = i == null ? void 0 : i.svg) != null && s.content) return G.createElement((r = i == null ? void 0 : i.svg) == null ? void 0 : r.content, !1);
      if ((o = i == null ? void 0 : i.text) != null && o.content) return G.createElement((a = i == null ? void 0 : i.text) == null ? void 0 : a.content, !0);
    }
  }, {
    key: "processElement",
    ...
    value: function createSpecificStateElement(e, t, i) {
      var s;
      return i && (s = G.createCustomElement(t, i)), G.processElement(e, s), s;
    }
    ...
    value: function createInnerElement(e, t, i, s) {
      var r = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : !1;
      var o, a;
      return r && !((a = (o = s == null ? void 0 : s[i]) == null ? void 0 : o.svg) != null && a.content) ? t : G.createSpecificStateElement(e, i, s) || t;
    }
  }]);
}();
var N = /*#__PURE__*/function () {
  ...
  return _createClass(N, null, [{
    ...
    value: function setElementCssUpToState(e, t, i) {
      N.setElementsCSS(e, t, "default"), i !== "default" && (N.setElementsCSS(e, t, "hover"), i !== "hover" && N.setElementsCSS(e, t, "click"));
    }
  }]);
}();
var ot = /*#__PURE__*/function () {
  ...
  return _createClass(ot, [{
    ...
    value: function buttonMouseLeave(e) {
      this._mouseState.state = "default", e && (N.unsetAllCSS(this.elementRef, e), N.setElementsCSS(this.elementRef, e, "default"));
    }
  }, {
    key: "buttonMouseEnter",
    value: function buttonMouseEnter(e) {
      this._mouseState.state = "hover", e && N.setElementsCSS(this.elementRef, e, "hover");
    }
  }, {
    key: "buttonMouseUp",
    value: function buttonMouseUp(e) {
      e && N.unsetActionCSS(this.elementRef, e), this.buttonMouseEnter(e);
    }
  }, {
    key: "buttonMouseDown",
    value: function buttonMouseDown(e) {
      this._mouseState.state = "click", e && N.setElementsCSS(this.elementRef, e, "click");
    }
    ...
    value: function unsetCustomStateStyles(e) {
      if (this._customStyles) for (var t = 0; t < e.length; t += 1) {
        var _i2 = e[t],
          s = _i2 && this._customStyles[_i2];
        s && N.unsetActionCSS(this.elementRef, s);
      }
    }
  }, {
    ...
    value: function reapplyStateStyle(e, t) {
      ...
      i && N.setElementCssUpToState(this.elementRef, i, this._mouseState.state), this.setEvents(i);
    }
  }]);
}();
var Fi = /*#__PURE__*/function (_ot) {
  function Fi(e) {
    var _this40;
    _classCallCheck(this, Fi);
    _this40 = _callSuper(this, Fi, [document.createElement("div"), void 0, e]), _this40.isActive = !1, _this40._innerElements = _this40.createInnerElements(_this40._customStyles), _this40.changeToDefault();
    return _this40;
  }
  _inherits(Fi, _ot);
  return _createClass(Fi, [{
    ...
    value: function createInnerElements(e) {
      var i, s;
      var t = V.createSVGElement(((s = (i = e == null ? void 0 : e["default"]) == null ? void 0 : i.svg) == null ? void 0 : s.content) || Fi.EMPTY_SVG);
      return {
        "default": this.createInnerElement(t, "default", e),
        active: this.createInnerElement(t, "active", e),
        unavailable: this.createInnerElement(t, "unavailable", e)
      };
    }
    // prettier-ignore
  }, {
    ...
    value: function createInnerElement(e, t, i) {
      return G.createSpecificStateElement(this.elementRef, t, i) || e;
    }
  }, {
    key: "changeToActive",
    value: function changeToActive() {
      this.elementRef.replaceChildren(this._innerElements.active), this.reapplyStateStyle("active", ["unavailable", "default"]), this.isActive = !0;
    }
  }, {
    key: "changeToDefault",
    value: function changeToDefault() {
      var e, t, i, s;
      this.elementRef.replaceChildren(this._innerElements["default"]), (e = this._customStyles) != null && e.active && N.unsetAllCSS(this.elementRef, (t = this._customStyles) == null ? void 0 : t.active), (i = this._customStyles) != null && i.unavailable && N.unsetAllCSS(this.elementRef, (s = this._customStyles) == null ? void 0 : s.unavailable), this.reapplyStateStyle("default", ["active", "unavailable"]), this.isActive = !1;
    }
  }, {
    key: "changeToUnavailable",
    value: function changeToUnavailable() {
      var e, t, i, s;
      this.elementRef.replaceChildren(this._innerElements.unavailable), (e = this._customStyles) != null && e.active && N.unsetAllCSS(this.elementRef, (t = this._customStyles) == null ? void 0 : t.active), (i = this._customStyles) != null && i["default"] && N.unsetAllCSS(this.elementRef, (s = this._customStyles) == null ? void 0 : s["default"]), this.reapplyStateStyle("unavailable", ["default", "active"]), this.isActive = !1;
    }
  }]);
}(ot);
...
var U = /*#__PURE__*/function () {
  ...
  return _createClass(U, null, [{
    ...
    value: function setPropertyValueIfDoesNotExist(e, t, i) {
      var _e$s, _e$s2;
      var s = t[0];
      t.length === 1 ? (_e$s = e[s]) !== null && _e$s !== void 0 ? _e$s : e[s] = i : ((_e$s2 = e[s]) !== null && _e$s2 !== void 0 ? _e$s2 : e[s] = {}, t.shift(), U.setPropertyValueIfDoesNotExist(e[s], t, i));
    }
  }, {
    ...
    value: function setPropertyValue(e, t, i) {
      var _e$s3;
      var s = t[0];
      t.length === 1 ? e[s] = i : ((_e$s3 = e[s]) !== null && _e$s3 !== void 0 ? _e$s3 : e[s] = {}, t.shift(), U.setPropertyValue(e[s], t, i));
    }
  }, {
    key: "getObjectValue",
    value: function getObjectValue(e, t) {
      var i = t[0],
        s = e[i];
      return s === void 0 || t.length === 1 ? s : U.getObjectValue(s, t.slice(1));
    }
  }, {
    key: "overwritePropertyObjectFromAnother",
    value: function overwritePropertyObjectFromAnother(e, t, i) {
      var s = U.getObjectValue(t, i);
      if (s) {
        var r = _objectSpread(_objectSpread({}, s), U.getObjectValue(e, i) || {});
        U.setPropertyValue(e, i, r);
      }
    }
  }, {
    key: "isJson",
...
var Ln = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n<svg viewBox=\"0 0 32 32\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\">\n  <title>play</title>\n  <path d=\"M5.92 24.096q0 1.088 0.928 1.728 0.512 0.288 1.088 0.288 0.448 0 0.896-0.224l16.16-8.064q0.48-0.256 0.8-0.736t0.288-1.088-0.288-1.056-0.8-0.736l-16.16-8.064q-0.448-0.224-0.896-0.224-0.544 0-1.088 0.288-0.928 0.608-0.928 1.728v16.16z\"></path>\n</svg>",
  ...
  T = /*#__PURE__*/function (_K5) {
    function T(e) {
      ...
      var t = JSON.parse(JSON.stringify(e.directConnection)),
        i = T.getKey(e);
      _this41 = _callSuper(this, T, [e, L.buildKeyVerificationDetails(), L.buildHeaders, {
        key: i
      }]), _this41.insertKeyPlaceholderText = "OpenAI API Key", _this41.keyHelpUrl = "https://platform.openai.com/account/api-keys", _this41._muteButton = null, _this41._toggleButton = null, _this41._errorElement = null, _this41._loadingElement = null, _this41._pc = null, _this41._mediaStream = null, _this41._isMuted = !1;
    ...
    return _createClass(T, [{
      ...
      value: function createButtonsContainer() {
        var s;
        var e = document.createElement("div");
        e.id = "deep-chat-openai-realtime-buttons-container", Object.assign(e.style, (s = this._buttonsConfig) == null ? void 0 : s.container), this._muteButton = this.createMuteButton();
        var t = T.createButtonContainer(this._muteButton.elementRef);
        this._toggleButton = this.createToggleButton();
        var i = T.createButtonContainer(this._toggleButton.elementRef);
          ...
          return _regeneratorRuntime().wrap(function _callee93$(_context93) {
            while (1) switch (_context93.prev = _context93.next) {
              ...
              case 27:
                ...
                console.error("Failed to start conversation:", _context93.t1), _this43.displayError("Error"), _this43.hideLoading();
              case 30:
              case "end":
            ...
            while (1) switch (_context96.prev = _context96.next) {
              case 0:
                    ...
                    return _regeneratorRuntime().wrap(function _callee94$(_context94) {
                      while (1) switch (_context94.prev = _context94.next) {
                        ...
                        case 7:
                          ...
                          break;
                        case 11:
                          console.error("No streams found in the ontrack event."), _this44.displayError("Error");
                        case 12:
                        case "end":
                ...
                return navigator.mediaDevices.getUserMedia({
                  ...
                  var c;
                  t === _this44._pc && (_this44._mediaStream = l, (c = _this44._pc) == null || c.addTrack(_this44._mediaStream.getTracks()[0]), _this44._isMuted && _this44.toggleMute(!1));
                })["catch"](function (l) {
                    ...
                    return _regeneratorRuntime().wrap(function _callee95$(_context95) {
                      while (1) switch (_context95.prev = _context95.next) {
                        case 0:
                          ...
                          _this44.removeUnavailable(), _this44._toggleButton && (P.removeAriaAttributes(_this44._toggleButton.elementRef), _this44._toggleButton.changeToActive()), _this44.hideLoading();
                          _context95.next = 20;
                          break;
                        case 5:
              ...
              case 41:
                ...
                console.error(_context96.t3), this.displayError("Error");
              case 44:
              case "end":
      ...
      value: function stopOnError(e) {
        this.stop(), console.error(e), this.displayError("Error");
      }
    }, {
      key: "stop",
      value: function stop() {
      ...
      key: "changeToUnavailable",
      value: function changeToUnavailable() {
        this._muteButton && T.changeButtonToUnavailable(this._muteButton), this._toggleButton && T.changeButtonToUnavailable(this._toggleButton);
      }
    }, {
      key: "changeToAvailable",
      value: function changeToAvailable() {
        this._muteButton && T.changeButtonToAvailable(this._muteButton), this._toggleButton && T.changeButtonToAvailable(this._toggleButton);
      }
    }, {
      key: "removeUnavailable",
      value: function removeUnavailable() {
        this._muteButton && T.removeButtonUnavailable(this._muteButton), this._toggleButton && T.removeButtonUnavailable(this._toggleButton);
      }
    }, {
      key: "createError",
      ...
      value: function displayFailedToRetrieveEphemeralKey(e) {
        console.error("Failed to retrieve ephemeral key"), console.error(e), this.displayError("Error");
      }
    }, {
      key: "displayError",
      value: function displayError(e) {
        var t;
        this._errorElement && (this._errorElement.style.display = "block", this._errorElement.textContent = ((t = this._errorConfig) == null ? void 0 : t.text) || e, this.changeToUnavailable());
      }
    }, {
      key: "createLoading",
          ...
          return _regeneratorRuntime().wrap(function _callee97$(_context97) {
            while (1) switch (_context97.prev = _context97.next) {
              case 0:
                ...
                throw Error("Please define the `function_handler` property inside the [openAI](https://deepchat.dev/docs/directConnection/openAI#Realtime) object.");
              case 2:
                _context97.next = 4;
      ...
      value: function createAvatar(e) {
        ...
        return t.id = "deep-chat-openai-realtime-avatar", Object.assign(t.style, (i = e == null ? void 0 : e.styles) == null ? void 0 : i.avatar), t.src = (e == null ? void 0 : e.src) || es, t;
      }
    }, {
      ...
      value: function changeButtonToUnavailable(e) {
        e.elementRef.classList.add(T.UNAVAILABLE), P.removeAriaBusy(e.elementRef), P.addAriaDisabled(e.elementRef), e.changeToUnavailable();
      }
    }, {
      ...
      value: function removeButtonUnavailable(e) {
        P.removeAriaDisabled(e.elementRef), e.elementRef.classList.remove(T.UNAVAILABLE);
      }
    }]);
  }(K);
...
var ft = /*#__PURE__*/function (_K6) {
  function ft(e) {
    ...
    _this46 = _callSuper(this, ft, [e, L.buildKeyVerificationDetails(), L.buildHeaders, i]), _this46.insertKeyPlaceholderText = "OpenAI API Key", _this46.keyHelpUrl = "https://platform.openai.com/account/api-keys", _this46.url = "https://api.openai.com/v1/audio/speech", _this46.permittedErrorPrefixes = ["Invalid"], _this46.introPanelMarkUp = "\n    <div style=\"width: 100%; text-align: center; margin-left: -10px\"><b>OpenAI : Text To Speech</b></div>\n    <p>Generate an audio file based on your text input.</p>\n    <p>Click <a href=\"https://platform.openai.com/docs/guides/text-to-speech\">here</a> for more information.</p>";
    var s = (r = t == null ? void 0 : t.openAI) == null ? void 0 : r.textToSpeech;
    _typeof(s) == "object" && Object.assign(_this46.rawBody, s), (_o$model = (o = _this46.rawBody).model) !== null && _o$model !== void 0 ? _o$model : o.model = ft.DEFAULT_MODEL, (_a$voice = (a = _this46.rawBody).voice) !== null && _a$voice !== void 0 ? _a$voice : a.voice = ft.DEFAULT_VOIDE, _this46.textInputPlaceholderText = "Insert text to generate audio", _this46.rawBody.response_format = "mp3";
    return _this46;
  }
  _inherits(ft, _K6);
...
ft.DEFAULT_MODEL = "tts-1", ft.DEFAULT_VOIDE = "alloy";
var as = ft;
var pe = /*#__PURE__*/function (_K7) {
  function pe(e) {
    var _o$model2;
    var _this47;
...
var _s = /*#__PURE__*/function (_K9) {
  function _s(e) {
    var _this50;
    _classCallCheck(this, _s);
    var i;
    var t = (i = e.directConnection) == null ? void 0 : i.assemblyAI;
    _this50 = _callSuper(this, _s, [e, zt.buildKeyVerificationDetails(), zt.buildHeaders, t, {
      audio: {}
    }]), _this50.insertKeyPlaceholderText = "AssemblyAI API Key", _this50.keyHelpUrl = "https://www.assemblyai.com/app/account", _this50.introPanelMarkUp = "\n    <div style=\"width: 100%; text-align: center; margin-left: -10px\"><b>AssemblyAI Audio</b></div>\n    <p><b>Upload an audio file</b> to transcribe it into text.\n    <p>\n      Click <a href=\"https://www.assemblyai.com/docs/Guides/transcribing_an_audio_file#get-started\">here</a> for more info.\n    </p>", _this50.url = "https://api.assemblyai.com/v2/upload", _this50.isTextInputDisabled = !0, _this50.textInputPlaceholderText = "Upload an audio file", _this50.permittedErrorPrefixes = ["Authentication", "Invalid"], _this50.canSendMessage = _s.canFileSendMessage;
    return _this50;
  }
  _inherits(_s, _K9);
...
var In = /*#__PURE__*/function (_K10) {
  // prettier-ignore
  function In(e, t, i, s, r) {
    var _this51;
    _classCallCheck(this, In);
    _this51 = _callSuper(this, In, [e, fe.buildSpeechKeyVerificationDetails(i), t, s, r]), _this51.insertKeyPlaceholderText = "Azure Speech Subscription Key", _this51.keyHelpUrl =
    // eslint-disable-next-line max-len
...
var gt = /*#__PURE__*/function (_K12) {
  ...
  function gt(e, t, i, s, r) {
    ...
    var o = JSON.parse(JSON.stringify(e.directConnection)),
      ...
      l = i || L.buildHeaders,
      c = s || o.openAI;
    _this55 = _callSuper(this, gt, [e, a, l, c]), _this55.insertKeyPlaceholderText = "OpenAI API Key", _this55.keyHelpUrl = "https://platform.openai.com/account/api-keys", _this55.url = "https://api.openai.com/v1/chat/completions", _this55.permittedErrorPrefixes = ["Incorrect"], _this55.asyncCallInProgress = !1, _this55._systemMessage = gt.generateSystemMessage("You are a helpful assistant.");
    var d = r || ((u = o.openAI) == null ? void 0 : u.chat);
    if (_typeof(d) == "object") {
      d.system_prompt && (_this55._systemMessage = gt.generateSystemMessage(d.system_prompt));
...
var xs = /*#__PURE__*/function (_gt) {
  function xs(e) {
    ...
    if (_this57 = _callSuper(this, xs, [e, ue.buildKeyVerificationDetails(s), ue.buildHeaders, i, r]), _this57.permittedErrorPrefixes = [ue.URL_DETAILS_ERROR_MESSAGE], _this57.isTextInputDisabled = !1, _typeof(r) == "object") {
    ...
    ue.validateURLDetails(s) ? _this57.url = xs.buildURL(s) : (_this57.isTextInputDisabled = !0, _this57.canSendMessage = function () {
      return !1;
    }, setTimeout(function () {
      e.addMessage({
        error: ue.URL_DETAILS_ERROR_MESSAGE
  ...
  return _createClass(ea, null, [{
    ...
    function create(e) {
      ...
      if (t) {
        ...
        if (t.azure) {
          if (t.azure.openAI) {
            if (t.azure.openAI.chat) return new xs(e);
            if (t.azure.openAI.assistant) return new ns(e);
          }
          if (t.azure.speechToText) return new hs(e);
          if (t.azure.textToSpeech) return new ds(e);
  ...
  J = /*#__PURE__*/function () {
    ...
    return _createClass(J, null, [{
      ...
      value: function createImage(e, t, i) {
        var s = new Image();
        return s.src = e.src, i && z.scrollDownOnImageLoad(s.src, t), z.processContent("image", s, s.src, e.name);
      }
      ...
      value: function createAnyFile(e) {
        ...
        var s = V.createSVGElement(ta);
        s.classList.add("any-file-message-icon"), i.appendChild(s);
        var r = document.createElement("div");
        return r.classList.add("any-file-message-text"), r.textContent = e.name || z.DEFAULT_FILE_NAME, t.appendChild(i), t.appendChild(r), z.processContent("any", t, e.src, r.textContent);
      }
    }, {
      ...
      value: function createMessages(e, t, i) {
        ...
        return t.map(function (r) {
          return r.ref && (r = z.removeFileRef(r)), z.isAudioFile(r) ? J.createNewAudioMessage(e, r, i, s) : z.isImageFile(r) ? J.createImageMessage(e, r, i, s) : J.createNewAnyFileMessage(e, r, i, s);
        });
      }
    ...
    value: function updateFileMessages(e, t, i) {
      ...
      r.forEach(function (_ref33, p) {
        var f = _ref33.type,
          m = _ref33.elements;
        var g;
        z.setElementProps(e, m, f, s), (g = d.parentElement) == null || g.insertBefore(m.outerContainer, d), e.messageElementRefs.splice(e.messageElementRefs.length - 1, 1), e.messageElementRefs.splice(c + p, 0, m);
...
var de = /*#__PURE__*/function (_he) {
  function de(e, t, i) {
    ...
    }, e.clearMessages = _this61.clearMessages.bind(_this61, t), e.refreshMessages = _this61.refreshTextMessages.bind(_this61, e.remarkable), e.scrollToBottom = Z.scrollToBottom.bind(_this61, _this61.elementRef), e.addMessage = function (c, d) {
      _this61.addAnyMessage(_objectSpread(_objectSpread({}, c), {}, {
        sendUpdate: !!d
      }), !d);
    }, e.updateMessage = function (c, d) {
      return le.update(_this61, c, d);
    }, t.isWebModel() && t.setUpMessages(_this61), e.textToSpeech && mt.processConfig(e.textToSpeech, function (c) {
  ...
  return _createClass(de, [{
    ...
    value: function tryAddTextMessage(e, t, i) {
      var s = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : !1;
      var r = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : !1;
      !i.ignoreText && e.text !== void 0 && i.text !== null && (this.addNewTextMessage(e.text, e.role, t, r), !s && this.textToSpeech && e.role !== y.USER_ROLE && mt.speak(e.text, this.textToSpeech));
    }
  }, {
    ...
    value: function addNewErrorMessage(e, t) {
      ...
      var l = X.extractParticularSharedStyles(["fontSize", "fontFamily"], (u = this.messageStyles) == null ? void 0 : u["default"]);
      X.applyCustomStylesToElements(r, !1, l), X.applyCustomStylesToElements(r, !1, (h = this.messageStyles) == null ? void 0 : h.error), i || this.appendOuterContainerElemet(a), this.textToSpeech && mt.speak(s, this.textToSpeech), (f = this._onError) == null || f.call(this, s);
    }
  }, {
    ...
    value: function addLoadingMessage() {
      ...
      this.appendOuterContainerElemet(s.outerContainer), s.bubbleElement.classList.add(Pe.BUBBLE_CLASS), this.applyCustomStyles(s, y.AI_ROLE, !1, (d = (c = (l = this.messageStyles) == null ? void 0 : l.loading) == null ? void 0 : c.message) == null ? void 0 : d.styles), this.focusMode || Z.scrollToBottom(this.elementRef);
    }
  }, {
              ...
              return _context124.abrupt("return", Promise.all((e || []).map(function (t) {
                return new Promise(function (i) {
                  if (!t.type || t.type === "any") {
                    var s = t.file.name || z.DEFAULT_FILE_NAME;
                    i({
                      name: s,
                      type: "any",
                      ref: t.file
...
var q = /*#__PURE__*/function () {
  ...
  return _createClass(q, null, [{
    ...
    value: function adjustForOutsideButton(e, t, i) {
      i["outside-right"].length === 0 && i["outside-left"].length > 0 ? (e[0].classList.add(q.INPUT_OUTSIDE_LEFT_SMALL_ADJUSTMENT_CLASS), t.classList.add(q.INPUT_OUTSIDE_LEFT_SMALL_ADJUSTMENT_CLASS)) : i["outside-left"].length === 0 && i["outside-right"].length > 0 && (e[3].classList.add(q.INPUT_OUTSIDE_RIGHT_SMALL_ADJUSTMENT_CLASS), t.classList.add(q.INPUT_OUTSIDE_RIGHT_SMALL_ADJUSTMENT_CLASS));
    }
    ...
    value: function adjustOutsideSubmit(e, t, i) {
      if (!(i["inside-left"].length > 0 || i["inside-right"].length > 0)) {
        if (i["outside-right"].length === 0 && i["outside-left"].length > 0) return e[0].classList.add(q.INPUT_OUTSIDE_LEFT_ADJUSTMENT_CLASS), t.classList.add(q.INPUT_OUTSIDE_LEFT_ADJUSTMENT_CLASS), i["outside-left"].map(function (s) {
          return s.button.elementRef.classList.add("submit-button-enlarged");
        });
        if (i["outside-left"].length === 0 && i["outside-right"].length > 0) return e[3].classList.add(q.INPUT_OUTSIDE_RIGHT_ADJUSTMENT_CLASS), t.classList.add(q.INPUT_OUTSIDE_RIGHT_ADJUSTMENT_CLASS), i["outside-right"].map(function (s) {
          return s.button.elementRef.classList.add("submit-button-enlarged");
        });
      }
    }
    ...
    value: function set(e, t, i, s) {
      !!q.adjustOutsideSubmit(t, i, s) || q.adjustForOutsideButton(t, i, s), q.adjustInputPadding(e, s);
    }
  }]);
}();
...
var Ws = ["camera", "gifs", "images", "audio", "mixedFiles", "submit", "microphone"],
  On = "<?xml version=\"1.0\" standalone=\"no\"?>\n<!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.0//EN\" \"http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd\">\n<svg xmlns=\"http://www.w3.org/2000/svg\" stroke=\"currentColor\" fill=\"none\" stroke-width=\"1\" viewBox=\"0 0 24 24\" stroke-linecap=\"round\" stroke-linejoin=\"round\">\n  <line x1=\"22\" y1=\"2\" x2=\"11\" y2=\"14\"></line>\n  <polygon points=\"22 2 15 22 11 14 2 10 22 2\"></polygon>\n</svg>\n";
var ws = /*#__PURE__*/function () {
  function ws() {
    _classCallCheck(this, ws);
  }
  return _createClass(ws, null, [{
    key: "applyCustomStylesToDefault",
    value: function applyCustomStylesToDefault(e, t) {
      var i, s;
      for (var _i8 = 0, _Object$keys = Object.keys(e); _i8 < _Object$keys.length; _i8++) {
        var _i$item;
        var r = _Object$keys[_i8];
        (_i$item = (i = e[r]).item) !== null && _i$item !== void 0 ? _i$item : i.item = {};
        for (var _i9 = 0, _arr = ["default", "hover", "click"]; _i9 < _arr.length; _i9++) {
          var o = _arr[_i9];
          U.assignPropertyFromOneToAnother(o, e[r].item, (s = t[r]) == null ? void 0 : s.item);
        }
        U.assignPropertyFromOneToAnother("iconContainer", e[r], t[r]), U.assignPropertyFromOneToAnother("text", e[r], t[r]);
      }
    }
  }, {
    key: "createDropupStyles",
    value: function createDropupStyles() {
      ...
      return ws.applyCustomStylesToDefault(t, e), e;
    }
  }]);
}();
...
ge.MENU_ITEM_CLASS = "dropup-menu-item", ge.DISABLED_ITEM_CLASS = "dropup-menu-item-disabled", ge.ACTIVE_ITEM_CLASS = "dropup-menu-item-active";
var re = ge;
var pt = /*#__PURE__*/function (_ot2) {
  function pt(e, t) {
    var _this63;
    _classCallCheck(this, pt);
    var s, r;
    var i = ((s = e == null ? void 0 : e.dropupItem) == null ? void 0 : s.text) || "Custom ".concat(t);
    _this63 = _callSuper(this, pt, [pt.createButtonElement(), e == null ? void 0 : e.position, e == null ? void 0 : e.styles, i]), _this63._state = "default", _this63._innerElements = _this63.createInnerElements(_this63._customStyles), _this63._onClick = e.onClick, _this63._dropupStyles = ws.createDropupStyles((r = e.dropupItem) == null ? void 0 : r.styles), _this63.setSetState(e), _this63.addClickListener(), _this63.changeState(e.initialState, !0);
    return _this63;
  }
  _inherits(pt, _ot2);
  return _createClass(pt, [{
    ...
    value: function createInnerElements(e) {
      var s, r, o, a;
      var t = V.createSVGElement(On);
      t.id = "submit-icon";
      var i = (r = (s = e == null ? void 0 : e["default"]) == null ? void 0 : s.svg) != null && r.content ? V.createSVGElement((a = (o = e == null ? void 0 : e["default"]) == null ? void 0 : o.svg) == null ? void 0 : a.content) : t;
      return {
        "default": this.createInnerElement(i, "default", e),
        active: this.createInnerElement(i, "active", e),
        disabled: this.createInnerElement(i, "disabled", e)
      };
    }
    // prettier-ignore
  }, {
    ...
    value: function setSetState(e) {
      ...
      e.setState = {
        setDefault: function setDefault() {
          _this64.changeToDefault();
        },
        setActive: function setActive() {
          _this64.changeToActive();
        },
        setDisabled: function setDisabled() {
          _this64.changeToDisabled();
        }
      };
    }
  }, {
    ...
    value: function addClickListener() {
      ...
      this.elementRef.addEventListener("click", function () {
        var t;
        var e = (t = _this65._onClick) == null ? void 0 : t.call(_this65, _this65._state);
        (e === "default" || e === "active" || e === "disabled") && _this65.changeState(e);
      });
    }
  }, {
    key: "changeState",
    ...
    value: function changeToDefault(e) {
      var t, i, s, r;
      !e && this._state === "default" || (this.elementRef.classList.contains(re.MENU_ITEM_CLASS) ? (this.assignDropupItemStyle(this._dropupStyles["default"]), this.elementRef.classList.remove(re.DISABLED_ITEM_CLASS), this.elementRef.classList.remove(re.ACTIVE_ITEM_CLASS)) : (this.elementRef.replaceChildren(this._innerElements["default"]), (t = this._customStyles) != null && t.active && N.unsetAllCSS(this.elementRef, (i = this._customStyles) == null ? void 0 : i.active), (s = this._customStyles) != null && s.disabled && N.unsetAllCSS(this.elementRef, (r = this._customStyles) == null ? void 0 : r.disabled), this.reapplyStateStyle("default", ["active", "disabled"])), P.removeAriaDisabled(this.elementRef), this._state = "default");
    }
  }, {
    key: "changeToActive",
    value: function changeToActive(e) {
      !e && this._state === "active" || (this.elementRef.classList.contains(re.MENU_ITEM_CLASS) ? (this.assignDropupItemStyle(this._dropupStyles.active), this.elementRef.classList.remove(re.DISABLED_ITEM_CLASS), this.elementRef.classList.add(re.ACTIVE_ITEM_CLASS)) : (this.elementRef.replaceChildren(this._innerElements.active), this.reapplyStateStyle("active", ["disabled", "default"])), P.removeAriaDisabled(this.elementRef), this._state = "active");
    }
  }, {
    key: "changeToDisabled",
    value: function changeToDisabled(e) {
      var t, i, s, r;
      !e && this._state === "disabled" || (this.elementRef.classList.contains(re.MENU_ITEM_CLASS) ? (this.assignDropupItemStyle(this._dropupStyles.disabled), this.elementRef.classList.remove(re.ACTIVE_ITEM_CLASS), this.elementRef.classList.add(re.DISABLED_ITEM_CLASS)) : (this.elementRef.replaceChildren(this._innerElements.disabled), (t = this._customStyles) != null && t.active && N.unsetAllCSS(this.elementRef, (i = this._customStyles) == null ? void 0 : i.active), (s = this._customStyles) != null && s["default"] && N.unsetAllCSS(this.elementRef, (r = this._customStyles) == null ? void 0 : r["default"]), this.reapplyStateStyle("disabled", ["default", "active"])), P.addAriaDisabled(this.elementRef), this._state = "disabled");
    }
  }, {
    key: "setDropupItem",
    ...
    value: function createButtonElement() {
      var e = document.createElement("div");
      return e.classList.add("input-button"), e.classList.add(pt.BUTTON_CLASS), e;
    }
  }]);
}(ot);
...
var As = /*#__PURE__*/function () {
  ...
  return _createClass(As, [{
    ...
    value: function addItem(e) {
      var t = re.createItem(this, e, this._styles);
...
function Hi() {
  if (Js) return _t;
  Js = 1, Object.defineProperty(_t, "__esModule", {
    value: !0
  }), _t.Text = void 0;
  var n = /*#__PURE__*/function () {
    function n() {
  ...
  return _t.Text = n, n.FIRST_CHAR_REGEX = /\S/, n.DOUBLE_LINE = /\n\n/g, n.ONE_LINE = /\n/g, _t;
}
var Xs;
function Pn() {
  if (Xs) return St;
  Xs = 1, Object.defineProperty(St, "__esModule", {
    value: !0
  }), St.Translate = void 0;
  var n = Hi();
  ...
  return St.Translate = e, St;
}
var Ys;
function da() {
  if (Ys) return Et;
  Ys = 1, Object.defineProperty(Et, "__esModule", {
    value: !0
  }), Et.WebSpeechTranscript = void 0;
  var n = Pn();
  var e = /*#__PURE__*/function () {
    function e() {
      _classCallCheck(this, e);
  ...
  return Et.WebSpeechTranscript = e, Et;
}
var xt = {},
  Zs;
function Cs() {
  ...
  return xt.Browser = n, n.IS_SAFARI = function () {
...
function ha() {
  if (Qs) return At;
  Qs = 1, Object.defineProperty(At, "__esModule", {
    value: !0
  }), At.EventListeners = void 0;
  var n = /*#__PURE__*/function () {
    function n() {
      _classCallCheck(this, n);
    }
  ...
  return At.EventListeners = n, n.KEY_DOWN_TIMEOUT = null, At;
}
var Ct = {},
  en;
function ua() {
  if (en) return Ct;
  en = 1, Object.defineProperty(Ct, "__esModule", {
    value: !0
...
function Nn() {
  if (tn) return Rt;
  tn = 1, Object.defineProperty(Rt, "__esModule", {
    value: !0
  }), Rt.AutoScroll = void 0;
  var n = /*#__PURE__*/function () {
    function n() {
      _classCallCheck(this, n);
    }
...
function Gi() {
        ...
        for (var o = 0; o < t.childNodes.length; o += 1) {
          ...
          if (a.childNodes.length > 0) {
            ...
            if (s + a.textContent.length > i) {
              ...
              _l2.setStart(a, i - s), _l2.collapse(!0);
              var c = window.getSelection();
              return c == null || c.removeAllRanges(), c == null || c.addRange(_l2), t.focus(), -1;
            }
  ...
  return kt.Cursor = n, kt;
}
var rn;
function Dn() {
  if (rn) return Tt;
  rn = 1, Object.defineProperty(Tt, "__esModule", {
    value: !0
  }), Tt.CommandUtils = void 0;
  var n = Nn(),
    e = zi(),
    t = Cs(),
    i = Gi(),
    ...
    return _createClass(r, null, [{
      ...
      value: function execCommand(a, l, c, d, u) {
        ...
        var g = ((h = p.settings) === null || h === void 0 ? void 0 : h.caseSensitive) === !0 ? l : l.toLowerCase(),
          v = s.Text.breakupIntoWordsArr(g),
          M = ((f = p.settings) === null || f === void 0 ? void 0 : f.substrings) === !1 ? r.checkIfMatchesWord : r.checkIfMatchesSubstring;
        if (p.commandMode && M(p.commandMode, g, v)) return a.setInterimColorToFinal(), setTimeout(function () {
          return r.toggleCommandModeOn(a);
        }), {
          doNotProcessTranscription: !1
        };
        if (!(p.commandMode && !a.isWaitingForCommand)) {
          if (p.stop && M(p.stop, g, v)) return r.toggleCommandModeOff(a), setTimeout(function () {
            return a.stop();
          }), {
            doNotProcessTranscription: !1
          };
          if (p.pause && M(p.pause, g, v)) return r.toggleCommandModeOff(a), a.setInterimColorToFinal(), setTimeout(function () {
            var j;
            a.isPaused = !0, (j = a.onPauseTrigger) === null || j === void 0 || j.call(a, !0);
          }), {
            doNotProcessTranscription: !1
          };
          if (p.resume && M(p.resume, g, v)) return a.isPaused = !1, (m = a.onPauseTrigger) === null || m === void 0 || m.call(a, !1), r.toggleCommandModeOff(a), a.resetRecording(c), {
            doNotProcessTranscription: !0
          };
          if (p.reset && M(p.reset, g, v)) return u !== void 0 && r.setText(a, c, u, d), {
            doNotProcessTranscription: !0
          };
          if (p.removeAllText && M(p.removeAllText, g, v)) return r.setText(a, c, "", d), {
            doNotProcessTranscription: !0
          };
        }
      }
...
function pa() {
  ...
  return It.Padding = i, It;
}
var ln;
function Bn() {
  if (ln) return wt;
  ln = 1, Object.defineProperty(wt, "__esModule", {
    value: !0
  }), wt.Speech = void 0;
  var n = ha(),
    e = ua(),
    ...
    return _createClass(d, [{
      ...
      value: function prepareBeforeStart(h) {
        ...
        if (h != null && h.element) if (n.EventListeners.add(this, h), Array.isArray(h.element)) {
          var g = h.element.find(function (v) {
      ...
      value: function updateElements(h, f, m) {
        ...
        var v = this.commands && t.CommandUtils.execCommand(this, m, this._options, this._primitiveElement || this._genericElement, this._originalText);
        if (v) {
          if (v.doNotProcessTranscription) return;
          h = "", m = "";
        }
      ...
      value: function updateGenericElement(h, f, m) {
        ...
        var v = c.Text.lineBreak(f) + (m ? "" : this.endPadding);
        this.interimSpan.innerHTML = v, a.Browser.IS_SAFARI() && this.insertInCursorLocation && l.Cursor.setOffsetForSafariGeneric(h, p.length + v.length), g && i.AutoScroll.scrollGeneric(this, h), m && (this.scrollingSpan.innerHTML = "");
      }
    }, {
      key: "finalise",
  ...
  return wt.Speech = d, wt;
}
var cn;
function ma() {
  if (cn) return yt;
  cn = 1, Object.defineProperty(yt, "__esModule", {
    value: !0
  }), yt.WebSpeech = void 0;
  var n = da(),
    e = Cs(),
...
function ga() {
  ...
  return Ot.GlobalState = n, n.doubleClickPending = !1, Ot;
}
var Pt = {},
  Nt = {},
  hn;
function ba() {
  ...
  hn = 1, Object.defineProperty(Nt, "__esModule", {
    value: !0
  }), Nt.PreventConnectionStop = void 0;
  var n = /*#__PURE__*/function () {
    function n() {
      _classCallCheck(this, n);
    }
  ...
  return Nt.PreventConnectionStop = n, Nt;
}
var Dt = {},
  Bt = {},
  un;
function va() {
  return un || (un = 1, Object.defineProperty(Bt, "__esModule", {
    value: !0
  }), Bt.README_URL = void 0, Bt.README_URL = "https://github.com/OvidijusParsiunas/speech-to-element"), Bt;
}
var fn;
function ya() {
  if (fn) return Dt;
  fn = 1, Object.defineProperty(Dt, "__esModule", {
    value: !0
  }), Dt.AzureSpeechConfig = void 0;
  var n = va();
  var e = /*#__PURE__*/function () {
    function e() {
      _classCallCheck(this, e);
  ...
  return Dt.AzureSpeechConfig = e, Dt;
}
var Ft = {},
  pn;
function Ea() {
  if (pn) return Ft;
  pn = 1, Object.defineProperty(Ft, "__esModule", {
    value: !0
  }), Ft.StopTimeout = void 0;
  var n = /*#__PURE__*/function () {
    function n() {
      _classCallCheck(this, n);
    }
  ...
  return Ft.StopTimeout = n, n.DEFAULT_MS = 2e4, Ft;
}
var Ut = {},
  mn;
function Sa() {
  ...
  return Ut.AzureAudioConfig = n, Ut;
}
var jt = {},
  gn;
function _a() {
  ...
  return jt.AzureTranscript = e, jt;
}
var bn;
function xa() {
  if (bn) return Pt;
  bn = 1, Object.defineProperty(Pt, "__esModule", {
    value: !0
  }), Pt.Azure = void 0;
  var n = ba(),
    e = ya(),
...
var Le = /*#__PURE__*/function (_Oe) {
  ...
  return _createClass(Le, [{
    ...
    value: function addAudioElements(e, t) {
      ...
      s.src = t;
      var r = V.createSVGElement(Ln);
      r.classList.add("attachment-icon", "play-icon");
      var o = V.createSVGElement(rs);
...
var be = /*#__PURE__*/function () {
  ...
  return _createClass(be, [{
    ...
    value: function addButtons() {
      ...
      e.forEach(function (t) {
        P.addAttributes(t), _this80._buttonPanel.appendChild(t);
      });
    }
  }, {
    key: "close",
...
var Qe = be;
var Gt = /*#__PURE__*/function (_ot5) {
  // prettier-ignore
  function Gt(e, t, i, s, r, o) {
    var _this83;
    _classCallCheck(this, Gt);
    var u, h, f, m, p, g, v, M, j;
    ...
    _this83 = _callSuper(this, Gt, [Gt.createButtonElement(), a, i.button, l]);
    var c = a === "dropup-menu",
      d = _this83.createInnerElements(s, r, _this83._customStyles, c);
    _this83._inputElement = Gt.createInputElement((p = i == null ? void 0 : i.files) == null ? void 0 : p.acceptedFormats), _this83.addClickEvent(e, i), _this83.elementRef.replaceChildren(d.styles), _this83.reapplyStateStyle("styles"), _this83._fileAttachmentsType = t, _this83._openModalOnce = ((v = (g = i.files) == null ? void 0 : g.infoModal) == null ? void 0 : v.openModalOnce) === !1 || (j = (M = i.files) == null ? void 0 : M.infoModal) == null ? void 0 : j.openModalOnce;
    return _this83;
  }
  _inherits(Gt, _ot5);
  return _createClass(Gt, [{
    ...
    value: function createInnerElements(e, t, i) {
      var s = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : !1;
      var r = Gt.createSVGIconElement(e, t);
      return {
        styles: G.createInnerElement(this.elementRef, r, "styles", i, s)
      };
    }
  }, {
...
var et = /*#__PURE__*/function () {
  ...
  return _createClass(et, null, [{
    ...
    value: function overwriteDefaultStyleWithSubmit(e, t) {
      ...
      U.overwritePropertyObjectFromAnother(i, e.submit, ["container", "default"]), U.overwritePropertyObjectFromAnother(i, e.submit, ["text", "styles", "default"]), U.overwritePropertyObjectFromAnother(i, e.submit, ["svg", "styles", "default"]), e[t] = i;
    }
    // prettier-ignore
  }, {
    key: "setUpDisabledButton",
    value: function setUpDisabledButton(e) {
      U.setPropertyValueIfDoesNotExist(e, ["submit", "container", "default", "backgroundColor"], ""), U.setPropertyValueIfDoesNotExist(e, ["disabled", "container", "default", "backgroundColor"], "unset"), U.setPropertyValueIfDoesNotExist(e.submit, ["svg", "styles", "default", "filter"], ""), U.setPropertyValueIfDoesNotExist(e.disabled, ["svg", "styles", "default", "filter"], "brightness(0) saturate(100%) invert(70%) sepia(0%) saturate(5564%) hue-rotate(207deg) brightness(100%) contrast(97%)"), et.overwriteDefaultStyleWithSubmit(e, "disabled");
    }
  }, {
    key: "process",
...
var I = /*#__PURE__*/function (_ot6) {
  // prettier-ignore
  function I(e, t, i, s, r, o) {
    var _this88;
    _classCallCheck(this, I);
    var a = et.process(e.submitButtonStyles);
    _this88 = _callSuper(this, I, [I.createButtonContainerElement(), a == null ? void 0 : a.position, a]), _this88._isSVGLoadingIconOverriden = !1, _this88.status = {
      requestInProgress: !1,
      loadingActive: !1
    }, _this88._messages = i, _this88._textInput = t, _this88._fileAttachments = r, _this88._innerElements = _this88.createInnerElements(), _this88._abortStream = new AbortController(), _this88._stopClicked = {
      listener: function listener() {}
      ...
      var l;
      _this88._validationHandler = e._validationHandler, _this88.assignHandlers(_this88._validationHandler), (l = _this88._validationHandler) == null || l.call(_assertThisInitialized(_this88));
    });
    return _this88;
  }
  _inherits(I, _ot6);
  return _createClass(I, [{
    ...
    value: function createCustomElements() {
      var _this89 = this;
      var e = G.createSpecificStateElement(this.elementRef, "submit", this._customStyles),
        t = {
          loading: void 0,
          stop: void 0
        };
      return Object.keys(t).forEach(function (i) {
        var s = i,
          r = G.createCustomElement(s, _this89._customStyles);
        r && (t[s] = r);
      }), t.submit = e, t;
    }
  }, {
    ...
    value: function createDisabledIconElement(e) {
      return G.createCustomElement("disabled", this._customStyles) || e.cloneNode(!0);
    }
    // prettier-ignore
  }, {
...
var Ts = /*#__PURE__*/function (_Qe) {
  // prettier-ignore
  function Ts(e, t, i, s) {
    var _this92;
    _classCallCheck(this, Ts);
    _this92 = _callSuper(this, Ts, [e, ["modal-content", "modal-camera-content"], i]), _this92._stopped = !1, _this92._format = "image/png", _this92._canvas = document.createElement("canvas"), _this92._canvas.classList.add("camera-modal-canvas");
    ...
    _this92._captureButton = r, _this92._submitButton = o, _this92._captureIcon = _this92._captureButton.children[0], _this92._refreshIcon = V.createSVGElement(Ma), _this92._refreshIcon.classList.add("modal-svg-button-icon", "modal-svg-refresh-icon"), (s == null ? void 0 : s.format) === "jpeg" && (_this92._format = "image/jpeg"), s != null && s.dimensions && (_this92._dimensions = s.dimensions), _this92._contentRef.appendChild(_this92._canvas), _this92.extensionCloseCallback = _this92.stop;
    return _this92;
  }
  _inherits(Ts, _Qe);
...
var Ni = /*#__PURE__*/function (_ot7) {
  ...
  return _createClass(Ni, [{
    ...
    function addClickEvent(e, t, i, s) {
      var r = Ts.createCameraModalFunc(e, t, i, s);
  ...
  return _createClass(Vt, [{
    ...
    function createFileUploadComponents(e, t, i, s) {
      ...
      if ((l = t.recordAudio) != null && l.files) {
        ...
        s.microphone = {
          button: new Ra(_d, t.recordAudio)
        };
      }
    ...
    value: function addElements(e, t, i, s, r, o) {
      ...
      ps.set(t.inputElementRef, a, r.elementRef, l), vt.add(e, a);
    }
  }]);
}();
