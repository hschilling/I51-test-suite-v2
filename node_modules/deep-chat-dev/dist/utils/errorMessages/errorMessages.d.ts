...
export declare const ErrorMessages: {
    ...
    INVALID_MODEL_REQUEST: typeof getModelRequestMessage;
    INVALID_MODEL_RESPONSE: typeof getModelResponseMessage;
    INVALID_STREAM_ARRAY_RESPONSE: string;
    INVALID_STREAM_EVENT: string;
    INVALID_STREAM_EVENT_MIX: string;
    NO_VALID_STREAM_EVENTS_SENT: string;
    READABLE_STREAM_CONNECTION_ERROR: string;
};
export {};
