/*!
 * rollup-plugin-baked-env v1.0.1 (https://github.com/victornpb/rollup-plugin-baked-env)
...
/**
  ...
  */
function envPlugin(variables = process.env, options = {}) {
  var _options$moduleName;
  const moduleName = (_options$moduleName = options.moduleName) != null ? _options$moduleName : 'process.env';
  ...
  return {
    ...
    load(id) {
      if (id === moduleName) {
        var _options$preferConst;
        let code = dataToEsm(variables, {
          namedExports: true,
          objectShorthand: true,
          // irrelevant as we don't use the default export
          // disableDefaultExport: true, // this option doesn't exist (TODO: make PR to propose @rollup/pluginutils)

          // code generation preferences
          preferConst: (_options$preferConst = options.preferConst) != null ? _options$preferConst : true,
...
export { envPlugin as default };
//# sourceMappingURL=rollup-plugin-baked-env.mjs.map
